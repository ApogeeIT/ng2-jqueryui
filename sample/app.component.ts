...
@Component({
    ...
    template: `
        <div>
            ...
            <jqui-datepicker [(ngModel)]="model.date" [uiDateFormat]="'dd/mm/yy'" [uiDisabled]="datePickerActive"></jqui-datepicker> - <jqui-datepicker [(ngModel)]="model.date" [uiDateFormat]="'dd/mm/yy'"></jqui-datepicker>
            <br>
